...
//    {
//        // 닉네임 설정
//        PhotonNetwork.NickName = "기획자" + Random.Range(1, 1000);
//        // 기본 Lobby 입장
...
//        // Room 참여 or 생성
//        PhotonNetwork.JoinOrCreateRoom("TargetMS__ROOM", roomOption, TypedLobby.Default);
//    }
...
public class SimpleConnection : MonoBehaviourPunCallbacks
{
    ...
    {
        // 닉네임 설정
        PhotonNetwork.NickName = "참가자" + Random.Range(1, 1000);
        // 기본 Lobby 입장
        PhotonNetwork.JoinLobby();
    }
